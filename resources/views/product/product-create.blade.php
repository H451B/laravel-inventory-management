            ...
            <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        ...
                        <input type="number" name="unit_purchase_price" class="form-control"
                            placeholder="Unit Purchase Price" id="unit_purchase_price">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" name="unit_selling_price" class="form-control"
                            placeholder="Unit Selling Price" id="unit_selling_price">
                        @error('unit_selling_price')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    {{-- <div class="col-sm-4">
                        <p class="m-0 p-0 fw-bold"> Discount Percentage:</p>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <p class="m-0 p-0 fw-bold"> Images: <span style="color:red">*</span></p>
                        <input type="file" name="images" class="form-control" placeholder="New Role"
                            id="imagesInput">
                        <br>
